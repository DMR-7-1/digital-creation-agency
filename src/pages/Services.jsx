  ...
  return (
    <div className="section" style={{ paddingTop: '8rem' }}>
      <div className="container">
        ...
        <div className="mobile-dense-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem', marginBottom: '6rem' }}>
          <FeatureCard 
        ...
        <div className="mobile-dense-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem' }}>
          {plans.map((plan, idx) => (
