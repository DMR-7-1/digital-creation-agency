      ...
      <section id="contact" className="section" style={{ paddingBottom: '8rem' }}>
        <div className="container" style={{ maxWidth: '600px', textAlign: 'center' }}>
          <div className="glass-panel" style={{ padding: '4rem 3rem' }}>
            ...
            <h2 style={{ fontSize: '2rem', marginBottom: '1rem', color: '#4ADE80' }}>وصلنا طلبك! ✅</h2>
      ...
      <div className="container" style={{ maxWidth: '800px', textAlign: 'center' }}>
        <AnimatedSection>
          ...
          <p style={{ marginBottom: '3rem' }}>
            قولنا وش تحتاج ونحن نتكفّلوا بالباقي. <strong>الاستشارة مجانية</strong> — بلا التزام.
          </p>
        </AnimatedSection>
        ...
        <FadeIn delay={0.2}>
          <div className="glass-panel" style={{ padding: '3rem', textAlign: 'right' }}>
            <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'grid', gap: '0.5rem' }}>
                <label style={{ fontSize: '0.9rem', fontWeight: '600' }}>قولنا على فكرتك (اختياري)</label>
                <textarea 
                  ...
                  placeholder="وصفلنا مشروعك باختصار..."
                />
              </div>
